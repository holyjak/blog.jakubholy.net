{:title "How to use Clojure 1.10 pREPL to connect to a remote server (WIP)"
 ...
 :category "Languages"
 :toc true
 :slug "how-to-use-clojure-1.10-prepl"
}
...
_Update 22/3_: Check out O. Caldwell’s https://oli.me.uk/2019-03-22-clojure-socket-prepl-cookbook/[Clojure socket prepl cookbook].
...
(Thanks to Oliver Caldwell’ https://gist.github.com/Olical/8ddc726c41112be5eb450b12954d81f0[Vim Conjure plugin docs] for this!)
...
Check out the https://clojure.github.io/clojure/clojure.core-api.html#clojure.core.server[`+clojure.core.server+` api docs] and the prepl schema:
