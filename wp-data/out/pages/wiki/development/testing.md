...
* Mocks - "_objects pre-programmed with expectations which form a specification of the calls they are expected to receive_" => behavior verification (x state verif.)

## TDD & Value of Testing

Do I always need to write tests first? No, it is not suitable for example when exploring or in general when - for same rare reasons - the benefit is less than the cost (-> [Economics of Coding](http://theholyjava.wordpress.com/wiki/development/economics-of-coding/ "Economics of Coding")).
...
* Various
  ...
  - JBoss [Byteman](http://www.jboss.org/byteman) - tool for [fault injection into the tested code](http://theholyjava.wordpress.com/2012/02/25/cool-tools-fault-injection-into-unit-tests-with-jboss-byteman-easier-testing-of-error-handling/) via AOP and orchestrating multipe threads to exercise possible concurrency issues
...
* Mutation testing
  - [Jester](http://jester.sourceforge.net/ "Jester") (and Maven plugin Gester) - Kent Beck: _"Why just think your tests are good when you can know for sure? Sometimes Jester tells me my tests are airtight, but sometimes the changes it finds come as a bolt out of the blue. Highly recommended."_ [An intro article](http://www.ibm.com/developerworks/java/library/j-jester/ "An intro article").
...
* [http://www.browserstack.com/](http://www.browserstack.com/) -- testing with proper machine through the browser, support for IE, mobile, and more
...
@Test public void empty_credit_card_number_should_return_false ?
